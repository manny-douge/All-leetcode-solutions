...
#the same, whether it is signed or unsigned.  In Java, the compiler represents
#the signed integers using 2's complement notation. Therefore, in Example 3
#above, the input represents the signed integer. -3.  Follow up: If this
...
print(f"Input: {n}, Correct Answer: {ans}")
print(f"My answer: {Solution().hammingWeight(n)}")
